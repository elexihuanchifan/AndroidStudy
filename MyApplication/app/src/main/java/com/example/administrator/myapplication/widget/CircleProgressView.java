...
public class CircleProgressView extends View {
    ...
    private Paint.Cap mSpinnerStrokeCap = Paint.Cap.ROUND;
    //Paints
...
//        circleWidth = _circleBounds.width();
    ...
    private void drawCircleWithNumber(Canvas canvas, float _degrees) {
        ...
        canvas.drawArc(mCircleBounds, 0, _degrees, false, mBarPaint);
        ...
        canvas.drawText(text, mTextBounds.left - (mTextPaint.getTextSize() * 0.09f), mTextBounds.bottom + 2 * (mTextPaint.getTextSize() * 0.09f), mTextPaint);
        if (mShowUnit) {
