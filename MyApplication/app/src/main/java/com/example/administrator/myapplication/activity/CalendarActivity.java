...
import com.example.administrator.myapplication.widget.KCalendar;
...
public class CalendarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new PopupWindows(CalendarActivity.this, btnCalendar);
            }
        });
    }
    ...
    public class PopupWindows extends PopupWindow {
        ...
        public PopupWindows(Context mContext, View parent) {
            ...
            String[] dates = new String[]{"2016-07-01", "2016-07-05", "2016-07-08"};
            List<String> marksDates = new ArrayList<>();
            marksDates.add("2016-07-01");
            marksDates.add("2016-07-05");
            marksDates.add("2016-07-08");
//            calendar.setCalendarDayBgColor(dates , R.drawable.calendar_date_focused);
            calendar.addMarks(marksDates , R.drawable.calendar_date_focused);
        }
    }
}
